...
const GOOD_GAME_DATA: Partial<Project> = {
  ...
  ideaDescription: 'A social horror game where 4 players explore a haunted school. One player secretly becomes possessed and must sabotage the others.',
  vibeChips: ['Horror', 'Social', 'Competitive'],
  structuredIdea: {
    title: 'Possessed Academy',
    conceptParagraph: 'A 4-player horror experience set in a procedurally haunted school.',
    coreVerbs: ['Survive', 'Deceive', 'Investigate', 'Escape'],
    loopHook: 'Trust no one - anyone could be possessed',
  },
  finalTitle: 'Possessed Academy',
  finalConcept: 'Social deduction meets horror. 4 players, one is possessed.',
  gameQuestions: {
